...
// +kubebuilder:rbac:groups=api.external-secrets-operator.app,resources=externalsecrets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=api.external-secrets-operator.app,resources=externalsecrets/status,verbs=get;update;patch
...
func (r *ExternalSecretReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&apiv1alpha1.ExternalSecret{}).
		Complete(r)
}
