...
// +kubebuilder:rbac:groups=api.external-secrets-operator.app,resources=externalbackends,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=api.external-secrets-operator.app,resources=externalbackends/status,verbs=get;update;patch
...
func (r *ExternalBackendReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&apiv1alpha1.ExternalBackend{}).
		Complete(r)
}
